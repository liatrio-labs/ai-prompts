...
- `browser-qa/` - Lightweight browser QA workflow for driving UI paths and reporting evidence-backed findings
...
| `browser-qa` | `skills/browser-qa/SKILL.md` | Run focused browser QA passes with critical-path checks, console evidence, screenshots, and concise defect reports. |
