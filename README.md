...
- `research-briefing-html-template/` - Standalone HTML research briefing template and interaction pattern for decision-ready reports
...
| `research-briefing-html-template` | `skills/research-briefing-html-template/SKILL.md` | Reformat completed research into a polished standalone HTML briefing with citations, tooltips, and decision-ready structure. |
